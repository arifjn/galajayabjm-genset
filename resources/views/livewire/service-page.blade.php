            ...
            <div class="lg:col-span-8">
                ...
                <div class="grid grid-cols-12 gap-2 sm:gap-6 items-center lg:-translate-x-4">
                    <div class="col-span-4">
                        <img class="rounded-xl" src="https://galajaya.com/_ph/1/2/347064123.jpg?1716382162"
                ...
                <div class="space-y-6 sm:space-y-8">
                    ...
                    <div class="space-y-2 md:space-y-4">
                        ...
                        <p class="text-gray-500">
                            Semua produk genset PT. Gala Jaya Banjarmasin di lindungi oleh kebijakan layanan purna jual
                            yang meliputi:
                        </p>
                    </div>
                    <!-- End Title -->
                    ...
                    <ul class="space-y-2 sm:space-y-4">
                        <li class="flex space-x-3">
                            <!-- Solid Check -->
                            <span
                                class="mt-0.5 size-5 flex justify-center items-center rounded-full bg-gray-50 text-gray-600">
                    ...
                    <div class="max-w-6xl py-2 mx-auto lg:py-0 mt-8">
                        <a href="{{ route('products') }}"
                            ...
                            <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" width="20" height="20" stroke="currentColor"
                                class="w-6 h-6">
            ...
            <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                ...
                <div class="text-center">
                    <p class="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3">
                        Konverting Watt ke KVA
                    </p>
                    <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight">
                        Hitung Kebutuhan Daya <span class="text-orange-500">Kapasitas Genset Anda</span>
                    </h1>
                </div>
                <!-- End Title -->
                ...
                <div class="space-x-3 p-3 rounded-lg mx-auto">
                    <div>
                        <div class="sm:flex flex rounded-lg shadow-sm border sm:flex sm:space-x-3 p-3">
                            ...
                            <span
                                ...
                                <svg class="sm:hidden mx-auto size-4 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                    ...
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-500 mt-2">Watt (1000 Watt = 1 kW)</span>
