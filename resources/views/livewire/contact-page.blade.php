...
<div class="w-full px-4 py-10 sm:px-6 lg:px-24 lg:py-14 mx-auto">
    <div class="mx-auto">
        ...
        <!-- Map -->
        <div class="p-4 mt-8 mx-auto bg-white shadow-md">
        ...
        <!-- contact -->
        <div class="mt-4 lg:py-20 py-10 grid items-start lg:grid-cols-2 gap-6 lg:gap-16">
            <!-- Card -->
            ...
            <div class="flex flex-wrap gap-y-2">
                ...
                <h2 class="pt-4 text-xl font-semibold text-gray-800 text-center w-full">
                    <div
