<div class="w-full max-w-[85rem] py-20 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl">
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span class="bg-yellow-400 py-1 px-3 rounded text-gray-800 shadow">Processing</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
        <div class="md:w-3/4">
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left font-semibold">Durasi</th>
                            <th class="text-left font-semibold">Harga Satuan</th>
                        ...
                        <tr wire:key="53">
                            <td class="py-4">
                                <div class="flex items-center">
                                    <img class="h-16 w-16 mr-4" src="https://galajaya.com/_ld/3/91617811.jpg"
                                        alt="Product image">
                                    <span class="font-semibold">Cummins 200 kVA</span>
                                </div>
                            </td>
                            <td class="py-4">1</td>
                            <td class="py-4">
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                <h1 class="font-3xl font-bold text-slate-500 mb-3">Lokasi Pengantaran</h1>
                <div class="flex justify-between items-center">
                    <div>
                        <p>Jl. Pramuka No. 06, Banjarmasin Tengah</p>
                    </div>
                    <div>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">Rp. 1.650.000</span>
                </div>
                <hr class="my-2">
                <div class="flex justify-between mb-2">
                    <span class="font-semibold">Grand Total</span>
                    <span class="font-semibold">Rp. 16.650.000</span>
                </div>
