...
use App\Http\Controllers\DendaPdfController;
...
use App\Http\Controllers\OperatorWorkPdfController;
...
use App\Http\Controllers\ReturnGensetPdfController;
...
Route::get('pdf-invoice-denda/{transaction:order_id}', [DendaPdfController::class, 'pdf'])->name('pdf.denda');
...
Route::get('pdf-operator_work/{plan:id}', [OperatorWorkPdfController::class, 'pdf'])->name('pdf.operator-work');
Route::get('pdf-penarikan/{plan:id}', [ReturnGensetPdfController::class, 'pdf'])->name('pdf.spk-penarikan');
